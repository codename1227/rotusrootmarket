        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            <div class="px-40 flex flex-1 justify-center py-5">
                <div class="layout-content-container flex flex-col max-w-[600px] flex-1">
					...
					<form action="${pageContext.request.contextPath}/items/add" method="post" enctype="multipart/form-data" class="flex flex-col gap-4 p-4 border rounded-lg">
						<input type="hidden" name="id" value="${sessionScope.loggedInUser}"/>
					    ...
					    <button type="submit" class="mt-4 cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 bg-[#f0f2f4] text-[#111318] text-sm font-bold leading-normal tracking-[0.015em] py-2 px-4 rounded-md">물품 등록하기</button>
					</form>
                </div>
            </div>
